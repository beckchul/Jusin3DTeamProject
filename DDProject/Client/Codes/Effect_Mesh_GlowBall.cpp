...
CEffect_Mesh_GlowBall::CEffect_Mesh_GlowBall(LPDIRECT3DDEVICE9 pGraphicDev)
	:CEffect_Mesh(pGraphicDev)
{
}

CEffect_Mesh_GlowBall::CEffect_Mesh_GlowBall(const CEffect_Mesh_GlowBall& rhs)
	: CEffect_Mesh(rhs)
{
...
CEffect_Mesh_GlowBall::~CEffect_Mesh_GlowBall(void)
{

}

CEffect_Mesh_GlowBall* CEffect_Mesh_GlowBall::Clone(void)
{
	return new CEffect_Mesh_GlowBall(*this);
}

HRESULT CEffect_Mesh_GlowBall::Ready_GameObject(void)
{
...
int CEffect_Mesh_GlowBall::Update_GameObject(const float & fTimeDelta)
{
...
void CEffect_Mesh_GlowBall::Render_GameObject(LPD3DXEFFECT pArgEffect, _uint uPassIdx)
{
...
HRESULT CEffect_Mesh_GlowBall::Add_Component(void)
{
	...
	// For.Mesh
	AddComponent(m_pStaticMeshCom, Engine::CStaticMesh*, SCENE_STATIC, L"Com_Mesh_GlowBall", Engine::CComponent::COM_STATIC, L"Com_Mesh");

	return NOERROR;
}

HRESULT CEffect_Mesh_GlowBall::Set_ConstantTable(LPD3DXEFFECT pEffect)
{
	if (nullptr == pEffect
...
CEffect_Mesh_GlowBall* CEffect_Mesh_GlowBall::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CEffect_Mesh_GlowBall* pInstance = new CEffect_Mesh_GlowBall(pGraphicDev);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		MessageBox(0, L"CEffect_Mesh_GlowBall Created Failed", nullptr, MB_OK);
		pInstance->Release();
	}
	return pInstance;
}

void CEffect_Mesh_GlowBall::Free(void)
{
	CEffect_Mesh::Free();
	cout << "CEffect_Mesh_GlowBall 소멸!" << endl;
}
