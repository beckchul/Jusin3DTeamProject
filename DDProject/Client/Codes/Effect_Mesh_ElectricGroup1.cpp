...
CEffect_Mesh_ElectricGroup1::CEffect_Mesh_ElectricGroup1(LPDIRECT3DDEVICE9 pGraphicDev)
	:CEffect_Mesh(pGraphicDev)
{
}

CEffect_Mesh_ElectricGroup1::CEffect_Mesh_ElectricGroup1(const CEffect_Mesh_ElectricGroup1& rhs)
	: CEffect_Mesh(rhs)
{
...
CEffect_Mesh_ElectricGroup1::~CEffect_Mesh_ElectricGroup1(void)
{

}

CEffect_Mesh_ElectricGroup1* CEffect_Mesh_ElectricGroup1::Clone(void)
{
	return new CEffect_Mesh_ElectricGroup1(*this);
}

HRESULT CEffect_Mesh_ElectricGroup1::Ready_GameObject(void)
{
	...
	//m_vColor = _vec4(0.f, 0.f, 1.f, 1.f);
	//m_fTime = 10.f;		// 8.f초 지나면 사라짐.
...
int CEffect_Mesh_ElectricGroup1::Update_GameObject(const float & fTimeDelta)
{
...
void CEffect_Mesh_ElectricGroup1::Render_GameObject(LPD3DXEFFECT pArgEffect, _uint uPassIdx)
{
...
HRESULT CEffect_Mesh_ElectricGroup1::Add_Component(void)
{
	...
	// For.Mesh
	AddComponent(m_pStaticMeshCom, Engine::CStaticMesh*, SCENE_STATIC, L"Com_Mesh_ElectricityGroup01", Engine::CComponent::COM_STATIC, L"Com_Mesh");

	return NOERROR;
}

HRESULT CEffect_Mesh_ElectricGroup1::Set_ConstantTable(LPD3DXEFFECT pEffect)
{
	if (nullptr == pEffect
...
CEffect_Mesh_ElectricGroup1* CEffect_Mesh_ElectricGroup1::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CEffect_Mesh_ElectricGroup1* pInstance = new CEffect_Mesh_ElectricGroup1(pGraphicDev);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		MessageBox(0, L"CEffect_Mesh_ElectricGroup1 Created Failed", nullptr, MB_OK);
		pInstance->Release();
	}
	return pInstance;
}

void CEffect_Mesh_ElectricGroup1::Free(void)
{
	CEffect_Mesh::Free();
	cout << "CEffect_Mesh_ElectricGroup1 소멸!" << endl;
}
