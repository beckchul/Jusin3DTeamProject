...
CEffect_Mesh_Projectile1::CEffect_Mesh_Projectile1(LPDIRECT3DDEVICE9 pGraphicDev)
	:CEffect_Mesh(pGraphicDev)
{
}

CEffect_Mesh_Projectile1::CEffect_Mesh_Projectile1(const CEffect_Mesh_Projectile1& rhs)
	: CEffect_Mesh(rhs)
...
CEffect_Mesh_Projectile1::~CEffect_Mesh_Projectile1(void)
{

}

CEffect_Mesh_Projectile1* CEffect_Mesh_Projectile1::Clone(void)
{
	return new CEffect_Mesh_Projectile1(*this);
}

HRESULT CEffect_Mesh_Projectile1::Ready_GameObject(void)
{
	...
	m_eShaderPass = EFFECT_MESH_PROJECTILE;

	return NOERROR;
}

int CEffect_Mesh_Projectile1::Update_GameObject(const float & fTimeDelta)
{
...
void CEffect_Mesh_Projectile1::Render_GameObject(LPD3DXEFFECT pArgEffect, _uint uPassIdx)
{
...
HRESULT CEffect_Mesh_Projectile1::Add_Component(void)
{
	...
	// For.Mesh
	AddComponent(m_pStaticMeshCom, Engine::CStaticMesh*, SCENE_STATIC, L"Com_Mesh_Projectile1", Engine::CComponent::COM_STATIC, L"Com_Mesh");
...
HRESULT CEffect_Mesh_Projectile1::Set_ConstantTable(LPD3DXEFFECT pEffect)
{
	if (nullptr == pEffect
...
CEffect_Mesh_Projectile1* CEffect_Mesh_Projectile1::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CEffect_Mesh_Projectile1* pInstance = new CEffect_Mesh_Projectile1(pGraphicDev);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		MessageBox(0, L"CEffect_Mesh_Projectile1 Created Failed", nullptr, MB_OK);
		pInstance->Release();
	}
	return pInstance;
}

void CEffect_Mesh_Projectile1::Free(void)
{
	Safe_Release(m_pTextureMaskCom);
	CEffect_Mesh::Free();
	cout << "CEffect_Mesh_Projectile1 소멸!" << endl;
}
