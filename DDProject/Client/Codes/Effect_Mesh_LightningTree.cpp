...
CEffect_Mesh_LightningTree::CEffect_Mesh_LightningTree(LPDIRECT3DDEVICE9 pGraphicDev)
	:CEffect_Mesh(pGraphicDev)
{
}

CEffect_Mesh_LightningTree::CEffect_Mesh_LightningTree(const CEffect_Mesh_LightningTree& rhs)
	: CEffect_Mesh(rhs)
{
...
CEffect_Mesh_LightningTree::~CEffect_Mesh_LightningTree(void)
{

}

CEffect_Mesh_LightningTree* CEffect_Mesh_LightningTree::Clone(void)
{
	return new CEffect_Mesh_LightningTree(*this);
}

HRESULT CEffect_Mesh_LightningTree::Ready_GameObject(void)
{
	...
	m_fTime = 6.f;		// 8.f초 지나면 사라짐.


	return NOERROR;
}

int CEffect_Mesh_LightningTree::Update_GameObject(const float & fTimeDelta)
{
...
void CEffect_Mesh_LightningTree::Render_GameObject(LPD3DXEFFECT pArgEffect, _uint uPassIdx)
{
...
HRESULT CEffect_Mesh_LightningTree::Add_Component(void)
{
	...
	// For.Mesh
	AddComponent(m_pStaticMeshCom, Engine::CStaticMesh*, SCENE_STATIC, L"Com_Mesh_LightningTree", Engine::CComponent::COM_STATIC, L"Com_Mesh");

	return NOERROR;
}

HRESULT CEffect_Mesh_LightningTree::Set_ConstantTable(LPD3DXEFFECT pEffect)
{
	if (nullptr == pEffect
...
CEffect_Mesh_LightningTree* CEffect_Mesh_LightningTree::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CEffect_Mesh_LightningTree* pInstance = new CEffect_Mesh_LightningTree(pGraphicDev);
...
void CEffect_Mesh_LightningTree::Free(void)
{
	CEffect_Mesh::Free();
	cout << "CEffect_Mesh_LightningTree 소멸!" << endl;
}
