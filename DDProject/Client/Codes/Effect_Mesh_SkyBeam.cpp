...
CEffect_Mesh_SkyBeam::CEffect_Mesh_SkyBeam(LPDIRECT3DDEVICE9 pGraphicDev)
	:CEffect_Mesh(pGraphicDev)
{
}

CEffect_Mesh_SkyBeam::CEffect_Mesh_SkyBeam(const CEffect_Mesh_SkyBeam& rhs)
	: CEffect_Mesh(rhs)
{
...
CEffect_Mesh_SkyBeam::~CEffect_Mesh_SkyBeam(void)
{

}

CEffect_Mesh_SkyBeam* CEffect_Mesh_SkyBeam::Clone(void)
{
	return new CEffect_Mesh_SkyBeam(*this);
}

HRESULT CEffect_Mesh_SkyBeam::Ready_GameObject(void)
{
...
int CEffect_Mesh_SkyBeam::Update_GameObject(const float & fTimeDelta)
{
...
void CEffect_Mesh_SkyBeam::Render_GameObject(LPD3DXEFFECT pArgEffect, _uint uPassIdx)
{
...
HRESULT CEffect_Mesh_SkyBeam::Add_Component(void)
{
	...
	// For.Mesh
	AddComponent(m_pStaticMeshCom, Engine::CStaticMesh*, SCENE_STATIC, L"Com_Mesh_SkyBeam", Engine::CComponent::COM_STATIC, L"Com_Mesh");

	return NOERROR;
}

HRESULT CEffect_Mesh_SkyBeam::Set_ConstantTable(LPD3DXEFFECT pEffect)
{
	if (nullptr == pEffect
...
CEffect_Mesh_SkyBeam* CEffect_Mesh_SkyBeam::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CEffect_Mesh_SkyBeam* pInstance = new CEffect_Mesh_SkyBeam(pGraphicDev);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		MessageBox(0, L"CEffect_Mesh_SkyBeam Created Failed", nullptr, MB_OK);
		pInstance->Release();
	}
	return pInstance;
}

void CEffect_Mesh_SkyBeam::Free(void)
{
	CEffect_Mesh::Free();
	cout << "CEffect_Mesh_SkyBeam 소멸!" << endl;
}
